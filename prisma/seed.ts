// Demo data: `npx prisma db seed` (or `railway run npx prisma db seed`).
// Idempotent: wipes and re-creates demo entities.
...
async function main() {
  ...
  // ── Demo criticalities (MANUAL source; AI sources arrive in Phase 4) ──
